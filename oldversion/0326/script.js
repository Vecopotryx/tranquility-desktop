...
$(function() {
    $("#ballIcon, #ballText").click(function() {
        ...
        unCollapse(bouncingballs, bouncingContent, collapseBounce, uncollapseBounce, null);
...
$(function() {
    $("#chipIcon, #chipText").click(function() {
        ...
        unCollapse(mediaplayer, mediaContent, collapseMedia, uncollapseMedia, null);
...
$(function() {
    $("#fourthBackground").click(function() {
        $('body').css('background-image', 'url("' + "source/img/andreas-gucklhorn-X3420VR5T9w-unsplash.jpg" + '")');
    }, )
});

$(function() {
    $("#fifthBackground").click(function() {
        $('body').css('background-image', 'url("' + "source/img/noaa-99F4mC79j1I-unsplash.jpg" + '")');
    }, )
});

$(function() {
    $("#sixthBackground").click(function() {
        $('body').css('background-image', 'url("' + "source/img/leon-ephraim-xV8uGe9gd6k-unsplash.jpg" + '")');
    }, )
});
...
$(function() {
    $("#arrangeToDefault").click(function() {
        ...
        if (isMediaCollapsed) {
            unCollapse(mediaplayer, mediaContent, collapseMedia, uncollapseMedia, mediaplayerHeight);
        }
        isMediaCollapsed = false;
